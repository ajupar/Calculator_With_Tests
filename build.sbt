...
// project description
description := "Unittest, contract, javafx template"

// main class
Compile/mainClass := Some("fi.utu.tech.test.AppMain")
...
val cofoja = "org.huoc" % "cofoja" % "1.3.1.5"

libraryDependencies ++= { if (useCofoja) Seq(cofoja) else Seq() }
...
unmanagedResourceDirectories in Compile ++= { if (useCofoja) Some(file("contracts/")) else None }
